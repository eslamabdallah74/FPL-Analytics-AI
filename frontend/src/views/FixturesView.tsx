...
export const FixturesView: React.FC = () => {
  ...
  if (loading || !data) {
    return <Loader message="Analyzing upcoming fixture difficulty ratings..." />;
  }
    ...
    <div className="space-y-6">
      <div className="glass-card p-5">
        <h1 className="text-2xl font-bold text-white flex items-center gap-2">
          ...
          <span>Fixture Planner & Difficulty Matrix</span>
        </h1>
        <p className="text-xs text-gray-400 mt-1">
          Analyzes upcoming opponent difficulty ratings over the next 5 Gameweeks to detect favorable fixture runs.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gradient-to-br from-emerald-500/10 to-teal-500/5 border border-emerald-500/30 rounded-2xl p-4">
          <h3 className="text-sm font-bold text-emerald-400 flex items-center gap-2 mb-3">
            ...
            <span>Easiest Upcoming Fixture Runs</span>
          </h3>
          <ul className="space-y-2 text-xs text-gray-300">
            {data.easy_runs.map((r) => (
              <li key={r.team_id} className="flex items-center justify-between bg-white/5 hover:bg-white/10 p-2.5 rounded-xl font-mono transition-colors">
        ...
        <div className="bg-gradient-to-br from-rose-500/10 to-pink-500/5 border border-rose-500/30 rounded-2xl p-4">
          <h3 className="text-sm font-bold text-rose-400 flex items-center gap-2 mb-3">
            ...
            <span>Toughest Upcoming Fixture Runs</span>
          </h3>
          <ul className="space-y-2 text-xs text-gray-300">
      ...
      <div className="glass-card overflow-hidden p-5">
        <h3 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4">
          Upcoming Schedule (Sorted by Easiest Schedule)
        </h3>
          ...
          <table className="w-full text-xs text-left">
            <thead>
              <tr className="text-gray-400 border-b border-white/10 uppercase">
                ...
                <th className="py-3 px-2 font-mono">Avg FDR</th>
                <th className="py-3 px-2 text-center">Next 5 Fixtures</th>
              </tr>
            </thead>
                  ...
                  <td className="py-3 px-2 font-sans font-bold text-white">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <span className="block text-[10px] text-gray-400 font-mono">{item.team_short}</span>
                      </div>
                    </div>
                  </td>
